...
<?php
if(!isset($_GET['bot'])){ echo "<script>self.location='?p=home'</script>"; break; }
if(!isset($_SESSION['errobot'])) $_SESSION['errobot']=0;
if($_GET['bot']<>$_SESSION['bot']){
	$_SESSION['errobot']=$_SESSION['errobot']+1;
	if($_SESSION['errobot']>=2){ echo "<script>self.location='?p=logout'</script>"; break; }
	echo "<script>self.location='?p=prepare&msg=1'</script>"; break;
}
$_SESSION['errobot']=0;
...
if(($dbi['renegado']=='sim')&&($db['renegado']=='sim')){ echo "<script>self.location='?p=hunt&msg=11'</script>"; break; }
