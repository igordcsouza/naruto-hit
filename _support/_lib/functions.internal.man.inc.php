...
function createTables($id=0)
{
	...
	else
	{
		...
		{
			$sql = "CREATE TABLE `".mysql_real_escape_string($_POST[POST_INTERN_DATABASE_PREFIX]).DATABASE_CHATS."` (`id` varchar(32) character set utf8 collate utf8_bin NOT NULL,`time` int(11) unsigned NOT NULL,`endtime` int(11) unsigned NOT NULL,`closed` int(11) unsigned NOT NULL,`chat_id` varchar(64) character set utf8 collate utf8_bin NOT NULL,`external_id` varchar(32) character set utf8 collate utf8_bin NOT NULL,`fullname` varchar(32) character set utf8 collate utf8_bin NOT NULL,`internal_id` varchar(32) character set utf8 collate utf8_bin NOT NULL,`html` longtext character set utf8 collate utf8_bin NOT NULL,`plain` longtext character set utf8 collate utf8_bin NOT NULL,`email` varchar(50) character set utf8 collate utf8_bin NOT NULL,`company` varchar(50) character set utf8 collate utf8_bin NOT NULL,`iso_language` varchar(8) character set utf8 collate utf8_bin NOT NULL,`host` varchar(64) character set utf8 collate utf8_bin NOT NULL,`ip` varchar(15) character set utf8 collate utf8_bin NOT NULL,`gzip` tinyint(1) unsigned NOT NULL,`transcript_sent` tinyint(1) unsigned NOT NULL DEFAULT '1', PRIMARY KEY(`id`)) ENGINE=MyISAM CHARACTER SET utf8 COLLATE utf8_bin;";
			...
			$sql = "CREATE TABLE `".mysql_real_escape_string($_POST[POST_INTERN_DATABASE_PREFIX]).DATABASE_DATA."` (`file` varchar(254) character set utf8 collate utf8_bin NOT NULL,`time` int(11) unsigned NOT NULL,`data` text character set utf8 collate utf8_bin NOT NULL,`size` mediumint(9) unsigned NOT NULL, UNIQUE KEY `file` (`file`)) ENGINE=MyISAM CHARACTER SET utf8 COLLATE utf8_bin;";
			$result = mysql_query($sql,$connection);
			if(!$result && mysql_errno() != 1050)
			{
				$RESPONSE->SetStandardResponse($id,base64_encode(mysql_errno() . ": " . mysql_error() . "\r\n\r\nSQL: " . $sql));
			...
			$sql = "CREATE TABLE `".mysql_real_escape_string($_POST[POST_INTERN_DATABASE_PREFIX]).DATABASE_INFO."` (`version` varchar(15) character set utf8 collate utf8_bin NOT NULL,`chat_id` int(11) unsigned NOT NULL default '11700',`ticket_id` int(11) unsigned NOT NULL default '11700', PRIMARY KEY  (`version`)) ENGINE=MyISAM CHARACTER SET utf8 COLLATE utf8_bin;";
			$result = mysql_query($sql,$connection);
			if(!$result && mysql_errno() != 1050)
			{
				$RESPONSE->SetStandardResponse($id,base64_encode(mysql_errno() . ": " . mysql_error() . "\r\n\r\nSQL: " . $sql));
			...
			$sql = "CREATE TABLE `".mysql_real_escape_string($_POST[POST_INTERN_DATABASE_PREFIX]).DATABASE_ROOMS."` (`id` int(11) NOT NULL,`time` int(11) NOT NULL,`last_active` int(11) NOT NULL,`status` tinyint(1) NOT NULL default '0',`target_group` varchar(64) NOT NULL, PRIMARY KEY  (`id`)) ENGINE=MyISAM CHARACTER SET utf8 COLLATE utf8_bin;";
			$result = mysql_query($sql,$connection);
			if(!$result && mysql_errno() != 1050)
			{
				$RESPONSE->SetStandardResponse($id,base64_encode(mysql_errno() . ": " . mysql_error() . "\r\n\r\nSQL: " . $sql));
			...
			$sql = "CREATE TABLE `".mysql_real_escape_string($_POST[POST_INTERN_DATABASE_PREFIX]).DATABASE_POSTS."` (`id` varchar(32) character set utf8 collate utf8_bin NOT NULL,`time` int(11) unsigned NOT NULL default '0',`micro` int(11) unsigned NOT NULL default '0',`sender` varchar(32) character set utf8 collate utf8_bin NOT NULL,`receiver` varchar(32) character set utf8 collate utf8_bin NOT NULL,`receiver_group` varchar(32) character set utf8 collate utf8_bin NOT NULL,`text` mediumtext character set utf8 collate utf8_bin NOT NULL,`received` tinyint(1) unsigned NOT NULL default '0',`persistent` tinyint(1) unsigned NOT NULL default '0', PRIMARY KEY  (`id`)) ENGINE=MyISAM CHARACTER SET utf8 COLLATE utf8_bin;";
			$result = mysql_query($sql,$connection);
			if(!$result && mysql_errno() != 1050)
			{
				$RESPONSE->SetStandardResponse($id,base64_encode(mysql_errno() . ": " . mysql_error() . "\r\n\r\nSQL: " . $sql));
