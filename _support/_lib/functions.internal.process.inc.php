...
/****************************************************************************************
* LiveZilla functions.internal.inc.php // VERSION 3.1.8.5
* 
...
{
	if(substr(strtolower($_POST[POST_INTERN_PROCESS_BANNERS . "_vb"]),strlen($_POST[POST_INTERN_PROCESS_BANNERS . "_vb"])-strlen(FILE_EXTENSION_BANNER),strlen(FILE_EXTENSION_BANNER)) == FILE_EXTENSION_BANNER)
		base64ToFile(PATH_BANNER.$_POST[POST_INTERN_PROCESS_BANNERS . "_vb"],$_POST[POST_INTERN_PROCESS_BANNERS . "_va"]);
	if(substr(strtolower($_POST[POST_INTERN_PROCESS_BANNERS . "_vd"]),strlen($_POST[POST_INTERN_PROCESS_BANNERS . "_vd"])-strlen(FILE_EXTENSION_BANNER),strlen(FILE_EXTENSION_BANNER)) == FILE_EXTENSION_BANNER)
