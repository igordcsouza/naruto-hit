...
foreach($API->GetOperators() as $operator)
{
	...
	echo "<tr>";
	echo "<td valign=\"top\">";
	echo "<img src=\"". $operator->GetOperatorPictureFile() ."\" width=\"60\" height=\"45\" style=\"border:solid 1px gray;\">";
	echo "</td>";
	echo "<td valign=\"top\">";
	...
	echo "<a href=\"javascript:void(window.open('". LIVEZILLA_PATH ."livezilla.php?intid=".$API->Base64UrlEncode($operator->UserId)."&amp;reset=true','','width=600,height=600,left=0,top=0,resizable=yes,menubar=no,location=no,status=yes,scrollbars=yes'))\">Start Chat</a>";
